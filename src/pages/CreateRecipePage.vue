  ...
  <div class="outer-container">
    <form>
      ...
      <div class="ingredients">
        <input v-model="quantity" type="number" placeholder="Menge" class="quantity" required=true id="quantity" >
        ...
        <input v-model="ingredient" placeholder="Zutat" class="ingredientInput" required=true id="ingredient">
